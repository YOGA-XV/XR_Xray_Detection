...
class DetectionTrainer(BaseTrainer):
    ...
    def preprocess_batch(self, batch: dict) -> dict:
        ...
        if self.data.get("xr_pcn", False) or self.data.get("xr_egi", False):
            batch["img"] = apply_xr_preprocess_tensor(
                batch["img"], use_pcn=self.data.get("xr_pcn", False), use_egi=self.data.get("xr_egi", False)
            )
