...
SOLUTIONS_HELP_MSG = f"""
    ...
    2. Call heatmap solution
        yolo solutions heatmap colormap=cv2.COLORMAP_PARULA model=yolov8n.pt

    3. Call queue management solution
        yolo solutions queue region="[(20, 400), (1080, 400), (1080, 360), (20, 360)]" model=yolov8n.pt

    4. Call workout monitoring solution for push-ups
        yolo solutions workout model=yolov8n-pose.pt kpts=[6, 8, 10]
...
def handle_yolo_solutions(args: list[str]) -> None:
    ...
    Examples:
        ...
        >>> handle_yolo_solutions(["inference", "model=yolov8n.pt"])
